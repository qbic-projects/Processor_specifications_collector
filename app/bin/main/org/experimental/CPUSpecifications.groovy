...
class Intel_Specifications_Fetcher implements Specifications_Fetcher {
    ...
    List<String> fetch_processor_family_addresses(String request_url) {
        Connection session = Jsoup.newSession() // String request_url = 'https://www.intel.com/content/www/us/en/ark.html'
        Document doc
        try {
            ...
            File doc_snapshot = new File('../resources/assets/Intel® Product Specifications.html')
    ...
    // Extract addresses from main ark
    List<String> fetch_processor_addresses() {
        Connection session = Jsoup.newSession()
        String request_url = 'https://www.intel.com/content/www/us/en/ark.html'
        Document doc
        try {
            Connection connection = session.url(request_url)
                                        .userAgent('Mozilla/5.0 \
